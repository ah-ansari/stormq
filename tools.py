...
def get_state(g: nx.Graph, feature_lmh_ranges):
    feature = get_feature(g)
    return feature_map_number(feature_map_lmh(feature, feature_lmh_ranges))
